...
The framing I'd use: NgRx Signals for state that _lives near the components that own it_. Traditional NgRx for state that needs to be auditable, shareable across many components, or heavily derived through a complex selector graph.
